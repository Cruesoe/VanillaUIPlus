...
- Reverse alert and letter order, hide individual play-settings buttons, or hide the speed buttons while keeping keyboard shortcuts. An optional Backslash shortcut toggles vanilla's temperature overlay and disables itself when Heat Map is active.
